...
xMat = mathutils.Matrix(
    (
        (1.0, 0.0, 0.0),
        (0.0, math.cos(xAng), -math.sin(xAng)),
        (0.0, math.sin(xAng), math.cos(xAng))
    ),
)
yMat = mathutils.Matrix(
    (
        (math.cos(yAng), 0.0, math.sin(yAng)),
        (0.0, 1.0, 0.0),
        (-math.sin(yAng), 0.0, math.cos(yAng))
    ),
)
zMat = mathutils.Matrix(
    (
